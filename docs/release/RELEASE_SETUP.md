...
This guide explains how to set up the GitHub secrets required for automated releases of burnrate.
...
burnrate uses Sparkle's channel feature to support beta updates. Users can opt into beta releases via Settings.
...
burnrate is available on [Homebrew Cask](https://formulae.brew.sh/cask/burnrate) and **updates automatically**.
...
- [Homebrew Cask burnrate](https://formulae.brew.sh/cask/burnrate)
