...
This document is the **single source of truth** for burnrate's architecture. All other documentation should reference this file.

## Overview

burnrate follows a **layered architecture** with clear separation of concerns:
...
{
    // Persists to ~/.burnrate/settings.json via JSONSettingsStore
...
└── App/                             # SwiftUI application
    ├── BurnrateApp.swift           # Entry point, wires dependencies
    ├── Views/                       # SwiftUI views
