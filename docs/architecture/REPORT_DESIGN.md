...
This document describes burnrate's report card system — analytics cards that parse local data sources, aggregate metrics, and display comparisons within the existing provider UI.
