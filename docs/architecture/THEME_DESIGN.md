...
This document describes the pluggable theme architecture in burnrate.

## Overview

burnrate uses a **protocol-based theme system** that allows easy creation and registration of new themes. The design follows the same patterns used throughout the codebase (ISP, Protocol-Based DI).
