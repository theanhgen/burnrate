...
All notable changes to burnrate will be documented in this file.
...
### Added
- **Extensions System**: Raycast-style user extensions for custom provider monitoring. Drop a folder with a `manifest.json` and probe scripts into `~/.burnrate/extensions/` to add your own provider. Each extension defines composable sections (`quotaGrid`, `metricsRow`, `dailyUsage`, `costUsage`, `statusBanner`, `healthCheck`) with per-section probe commands and independent refresh intervals. Probe scripts can be any language (bash, python, swift) — just output JSON to stdout. Extensions auto-register as providers with custom branding (icon, colors) and appear in the provider pills alongside built-in providers. See `docs/features/extensions.md` for the full spec and example.
- **Built-in Health Check for Extensions**: Extensions can now define a `healthCheck` section with a URL endpoint — no probe script needed. burnrate pings the URL and renders Status (UP/DOWN with HTTP code) and Latency cards automatically. Configure via `"probe": { "builtIn": "healthCheck", "url": "https://..." }` in `manifest.json`.
...
### Added
- **Burn Rate Warnings**: New pace-aware warning system that alerts based on consumption rate rather than fixed usage thresholds. Instead of warning at arbitrary percentages (e.g., 57% used = warning), it calculates whether you're on track to exhaust your quota before the period resets. For example, 57% used with 85% of the session elapsed is healthy (burn rate 0.67), while 53% used with only 8.5% of the week elapsed is a real warning (burn rate 6.2). Configurable threshold multiplier (1.2x–3.0x) in Settings. Disabled by default — opt in via Settings → Burn Rate Warnings. Critical (<20%) and depleted (0%) thresholds remain absolute as a safety net. ([#151](https://github.com/theanhgen/burnrate/issues/151))
...
### Improved
- **Settings Storage Migration**: Migrated all settings from UserDefaults to a unified JSON file (`~/.burnrate/settings.json`). Settings are now backed by `JSONSettingsRepository` with dot-notation key paths, making them easier to inspect, debug, and test. Credentials (GitHub token, MiniMax API key) remain in UserDefaults for now.
...
### Added
- **Daily Usage Report Cards**: See your daily Claude Code cost, token usage, and working time right in the menu bar. burnrate now analyzes your local session files (`~/.claude/projects/`) and displays three new cards below the quota cards:
...
- **Overview Mode AppLogo**: The header now displays the burnrate logo when Overview mode is enabled, instead of the last selected provider's icon.
...
### Added
- **Claude Code Session Tracking**: Real-time monitoring of Claude Code sessions via hooks. When Claude Code is running, burnrate shows session status directly in the menu bar and popover:
...
- Added `PortDiscovery` for writing/reading `~/.claude/burnrate-hook-port`
...
- Registered Kimi provider in `BurnrateApp` startup with both probes
...
- Registered Amp provider in `BurnrateApp` startup
- Comprehensive test coverage for probe parsing (130+ lines), probe behavior (127+ lines), and tier detection

## [0.4.26] - 2026-02-09

### Added
- **Launch at Login**: New toggle in Settings to automatically start burnrate when you log in to your Mac. Uses macOS native `SMAppService` — no helper app required.
- **Pace Tick Mark**: Visual tick mark below the consumption bar showing your expected usage pace. ([#96](https://github.com/theanhgen/burnrate/pull/96) - thanks [@frankhommers](https://github.com/frankhommers)!)

### Fixed
- **Claude API Cost Display**: API cost is now correctly converted from cents to dollars in Claude API mode. ([#95](https://github.com/theanhgen/burnrate/issues/95))
...
### Added
- **AWS Bedrock Support**: Monitor your AWS Bedrock AI usage directly from the menu bar. Track daily costs, token counts, and per-model breakdowns for your Claude, Llama, and other Bedrock models. ([#75](https://github.com/theanhgen/burnrate/pull/75) - thanks [@tomstetson](https://github.com/tomstetson)!)
...
### Improved
- **Better CLI Detection**: Fixed issues finding Claude, Codex, and other CLI tools on systems with custom shell configurations. The app now uses your login shell to properly resolve PATH ([#45](https://github.com/theanhgen/burnrate/issues/45)).
...
### Added
- **Pluggable Theme System**: burnrate now supports multiple visual themes with a protocol-based architecture. Switch themes instantly from Settings to match your workflow and preferences.
...
### Fixed
- **UI Layout Issues** ([#40](https://github.com/theanhgen/burnrate/issues/40)): Fixed layout constraints that caused views to break on certain screen sizes.
- **Claude Detection for API Accounts** ([#37](https://github.com/theanhgen/burnrate/issues/37)): Fixed issue where users with API Usage Billing accounts couldn't see Claude quota information.
...
### Added
- **Dual-Output Logging**: Logs now write to both OSLog (for developers via Console.app) and persistent files (for users) at `~/Library/Logs/burnrate/burnrate.log`
...
[Unreleased]: https://github.com/theanhgen/burnrate/compare/v0.4.57...HEAD
[0.4.57]: https://github.com/theanhgen/burnrate/compare/v0.4.56...v0.4.57
[0.4.56]: https://github.com/theanhgen/burnrate/compare/v0.4.55...v0.4.56
[0.4.55]: https://github.com/theanhgen/burnrate/compare/v0.4.54...v0.4.55
[0.4.54]: https://github.com/theanhgen/burnrate/compare/v0.4.53...v0.4.54
[0.4.53]: https://github.com/theanhgen/burnrate/compare/v0.4.52...v0.4.53
[0.4.52]: https://github.com/theanhgen/burnrate/compare/v0.4.51...v0.4.52
[0.4.51]: https://github.com/theanhgen/burnrate/compare/v0.4.50...v0.4.51
[0.4.50]: https://github.com/theanhgen/burnrate/compare/v0.4.49...v0.4.50
[0.4.49]: https://github.com/theanhgen/burnrate/compare/v0.4.48...v0.4.49
[0.4.48]: https://github.com/theanhgen/burnrate/compare/v0.4.47...v0.4.48
[0.4.47]: https://github.com/theanhgen/burnrate/compare/v0.4.46...v0.4.47
[0.4.46]: https://github.com/theanhgen/burnrate/compare/v0.4.45...v0.4.46
[0.4.45]: https://github.com/theanhgen/burnrate/compare/v0.4.44...v0.4.45
[0.4.44]: https://github.com/theanhgen/burnrate/compare/v0.4.43...v0.4.44
[0.4.43]: https://github.com/theanhgen/burnrate/compare/v0.4.43...v0.4.43
[0.4.43]: https://github.com/theanhgen/burnrate/compare/v0.4.42...v0.4.43
