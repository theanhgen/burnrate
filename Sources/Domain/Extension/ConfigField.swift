...
/// Values are injected as environment variables (BURNRATE_*) when probes execute.
public struct ConfigField: Sendable, Equatable, Codable {
    ...
    /// Converts the field id to BURNRATE_UPPER_SNAKE_CASE.
    /// Examples: "apiKey" → "BURNRATE_API_KEY", "base-url" → "BURNRATE_BASE_URL"
