...
/// File-based logger that writes to ~/Library/Logs/burnrate/burnrate.log
...
public final class FileLogger: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.nguyentheanh.burnrate.FileLogger")
    ...
    private init() {
        // ~/Library/Logs/burnrate/burnrate.log
        let logsDir = FileManager.default.urls(for: .libraryDirectory, in: .userDomainMask).first!
            .appendingPathComponent("Logs", isDirectory: true)
            .appendingPathComponent("burnrate", isDirectory: true)
        ...
        self.fileURL = logsDir.appendingPathComponent("burnrate.log")
    }
