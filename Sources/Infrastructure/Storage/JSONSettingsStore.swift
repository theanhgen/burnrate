...
///
/// File location: `~/.burnrate/settings.json` (default)
public final class JSONSettingsStore: @unchecked Sendable {
    ...
    /// - Parameter fileURL: Path to settings file. Defaults to `~/.burnrate/settings.json`.
    ...
    public static func defaultFileURL() -> URL {
        ...
        return home.appendingPathComponent(".burnrate/settings.json")
    }
