...
///
/// Backed by `JSONSettingsStore` reading/writing `~/.burnrate/settings.json`.
    ...
    @unchecked Sendable
{
    ...
    public func backgroundSyncInterval() -> TimeInterval {
        store.read(key: "app.backgroundSyncInterval") ?? 150
    }
    ...
    public func proactiveAlertsEnabled() -> Bool {
        store.read(key: "app.proactiveAlerts") ?? false
    }

    public func setProactiveAlertsEnabled(_ enabled: Bool) {
        store.write(value: enabled, key: "app.proactiveAlerts")
    }
    ...
    public func saveGithubToken(_ token: String) {
        credentials.set(token, forKey: "com.burnrate.credentials.github-copilot-token")
    }

    public func getGithubToken() -> String? {
        credentials.string(forKey: "com.burnrate.credentials.github-copilot-token")
    }

    public func deleteGithubToken() {
        credentials.removeObject(forKey: "com.burnrate.credentials.github-copilot-token")
    }
    ...
    public func saveGithubUsername(_ username: String) {
        credentials.set(username, forKey: "com.burnrate.credentials.github-username")
    }

    public func getGithubUsername() -> String? {
        credentials.string(forKey: "com.burnrate.credentials.github-username")
    }

    public func deleteGithubUsername() {
        credentials.removeObject(forKey: "com.burnrate.credentials.github-username")
    }
    ...
    public func saveAlibabaManualCookie(_ cookie: String) {
        credentials.set(cookie, forKey: "com.burnrate.credentials.alibaba-manual-cookie")
    }

    public func getAlibabaManualCookie() -> String? {
        credentials.string(forKey: "com.burnrate.credentials.alibaba-manual-cookie")
    }

    public func saveAlibabaApiKey(_ key: String) {
        credentials.set(key, forKey: "com.burnrate.credentials.alibaba-api-key")
    }

    public func getAlibabaApiKey() -> String? {
        credentials.string(forKey: "com.burnrate.credentials.alibaba-api-key")
    }

    public func deleteAlibabaApiKey() {
        credentials.removeObject(forKey: "com.burnrate.credentials.alibaba-api-key")
    }

    public func hasAlibabaApiKey() -> Bool {
        credentials.object(forKey: "com.burnrate.credentials.alibaba-api-key") != nil
    }
    ...
    public func saveMinimaxApiKey(_ key: String) {
        credentials.set(key, forKey: "com.burnrate.credentials.minimax-api-key")
    }

    public func getMinimaxApiKey() -> String? {
        credentials.string(forKey: "com.burnrate.credentials.minimax-api-key")
    }

    public func deleteMinimaxApiKey() {
        credentials.removeObject(forKey: "com.burnrate.credentials.minimax-api-key")
    }
